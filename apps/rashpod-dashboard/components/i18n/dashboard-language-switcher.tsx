...
export function DashboardLanguageSwitcher() {
  ...
  return (
    <label className="relative flex min-h-11 items-center rounded-xl border border-backoffice-border bg-backoffice-surface pl-9 hover:bg-backoffice-muted focus-within:ring-2 focus-within:ring-backoffice-focus">
      {isLocaleLoading ? (
      ...
      <select
        ...
        className="h-11 max-w-32 cursor-pointer appearance-none bg-transparent py-0 pl-0 pr-7 text-sm font-medium text-backoffice-text outline-none disabled:cursor-wait disabled:opacity-70 sm:max-w-none"
      >
