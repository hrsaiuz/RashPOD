      ...
      <DashboardPanel>
        <div className="p-8">
          <div className="border-2 border-dashed border-surface-border rounded-2xl p-12 flex flex-col items-center justify-center text-center bg-brand-bg/50 mb-8">
            <div className="w-16 h-16 bg-white rounded-full flex items-center justify-center shadow-soft mb-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
            {[1, 2, 3, 4, 5, 6].map(i => (
              <div key={i} className="group relative aspect-square rounded-xl bg-brand-bg border border-surface-borderSoft flex items-center justify-center overflow-hidden">
                ...
                <div className="absolute inset-0 bg-brand-ink/60 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                  <button className="w-8 h-8 bg-white rounded-full flex items-center justify-center text-semantic-danger shadow-soft hover:scale-105 transition-transform">
