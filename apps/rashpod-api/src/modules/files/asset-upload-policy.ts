...
export const ASSET_UPLOAD_POLICIES: Record<AssetPurpose, AssetUploadPolicy> = {
  ...
  DESIGNER_PORTFOLIO: {
    purpose: AssetPurpose.DESIGNER_PORTFOLIO,
    maxSizeBytes: 50_000_000,
    allowedMimeTypes: ["image/png", "image/jpeg", "image/webp", "application/pdf"],
    accessPolicy: AssetAccessPolicy.PRIVATE_SIGNED_URL,
    bucketKind: "private",
    pathSegment: "designer-intake/portfolio",
  },
  DESIGNER_IDENTITY: {
    purpose: AssetPurpose.DESIGNER_IDENTITY,
    maxSizeBytes: 20_000_000,
    allowedMimeTypes: ["image/png", "image/jpeg", "image/webp", "application/pdf"],
    accessPolicy: AssetAccessPolicy.INTERNAL_ONLY,
    bucketKind: "private",
    pathSegment: "designer-intake/identity",
  },
  DESIGNER_SELFIE: {
    purpose: AssetPurpose.DESIGNER_SELFIE,
    maxSizeBytes: 15_000_000,
    allowedMimeTypes: RASTER_IMAGE_MIME_TYPES,
    accessPolicy: AssetAccessPolicy.INTERNAL_ONLY,
    bucketKind: "private",
    pathSegment: "designer-intake/selfie",
  },
  PUBLIC_INTAKE_ATTACHMENT: {
    purpose: AssetPurpose.PUBLIC_INTAKE_ATTACHMENT,
    maxSizeBytes: 50_000_000,
    allowedMimeTypes: ["image/png", "image/jpeg", "image/webp", "application/pdf"],
    accessPolicy: AssetAccessPolicy.INTERNAL_ONLY,
    bucketKind: "private",
    pathSegment: "public-intake/attachments",
  },
  DESIGN_NORMALIZED: {
