...
export const rashpodTailwindTheme = {
  colors: {
    ...
    backoffice: {
      canvas: rashpodTokens.colors.backoffice.canvas,
      surface: rashpodTokens.colors.backoffice.surface,
      muted: rashpodTokens.colors.backoffice.surfaceMuted,
      border: rashpodTokens.colors.backoffice.border,
      accent: rashpodTokens.colors.backoffice.accent,
      "accent-soft": rashpodTokens.colors.backoffice.accentSoft,
      text: rashpodTokens.colors.backoffice.text,
      subtle: rashpodTokens.colors.backoffice.muted,
      focus: rashpodTokens.colors.backoffice.focus,
    },
